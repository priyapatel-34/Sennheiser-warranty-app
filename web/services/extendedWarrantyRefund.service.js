...
async function sendRefundCustomerEmail(
    ...
    await sendShopEmail({
        shopId: record.shop_id || entitlement.shop_id,
        templateKey:
            type === "approved"
...
//     const customerName = record.customer_name || entitlement.customer_name || "Customer";
//     const productTitle = record.product_name || entitlement.product_name || "Product";
//     const serialNumber = record.serial_number || entitlement.serial_number || "";
//     const planName = record.warranty_plan || entitlement.plan_name;
//     const formattedAmount = formatMoney(record.net_refund_amount, record.currency);
//     const registerId =
//         entitlement.registered_product_id || record.registered_product_id;
//     const shopId = record.shop_id || entitlement.shop_id;
...
//     const processedDate = formatDisplayDate(
//         type === "approved" ? record.approved_at || record.completed_at : record.rejected_at
//     );
...
//     const subject =
//         type === "approved"
//             ? "Extended Warranty Refund Approved"
//             : "Extended Warranty Refund Request Update";
