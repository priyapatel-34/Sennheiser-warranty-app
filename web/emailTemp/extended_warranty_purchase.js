...
/**
 * Renders the extended-warranty purchase confirmation email shown after a
 * customer completes the upsell checkout.
 */
...
// /**
//  * Fixed Extended Warranty Registration (purchase confirmation) email.
//  * Authored to match the same visual system as the approved Standard
//  * Warranty Registration design, extended with plan/price/coverage details.
//  * Layout/branding are not merchant-editable; only `additionalNotes` varies.
//  *
//  * `orderNumber` / `durationMonths` are accepted for data continuity (sample
//  * data, future use) but are not rendered directly — plan name + coverage
//  * dates already communicate the equivalent information in the details grid.
//  */
// export default function ExtendedWarrantyPurchaseTemplate({
//   customerName,
//   productTitle,
...
// <title>Extended Warranty Confirmed</title>
// <style>
...
//   .plan-pill { background: #F0F7FF; color: #1F4E79; font-size: 11px; font-weight: 700; padding: 4px 10px; border-radius: 20px; }
...
//       <div class="hero-label">✓ EXTENDED WARRANTY ACTIVE</div>
//       <h1>Your extended warranty is active</h1>
//       <p>Thank you for extending your coverage. Your extended warranty has been added to your product.<br>Keep this email as your proof of coverage.</p>
//     </div>
//   </div>
...
//     <p class="greeting">Your extended warranty purchase is confirmed. Here are the details of your coverage.</p>
...
//           <span class="warranty-badge">✓ Extended Warranty Active</span>
//           ${planName ? `<span class="plan-pill">${escapeHtml(planName)}</span>` : ""}
//         </div>
//       </div>
//     </div>
...
//         <div class="detail-value">${escapeHtml(amountPaid || "-")}</div>
//       </div>
//       <div class="detail-cell">
//         <div class="detail-label">Coverage starts</div>
//         <div class="detail-value">${escapeHtml(activationDate || "-")}</div>
//       </div>
//       <div class="detail-cell">
//         <div class="detail-label">Coverage ends</div>
//         <div class="detail-value">${escapeHtml(expiryDate || "-")}</div>
//       </div>
//     </div>
...
//     <p>
//       This email confirms your extended warranty purchase. Please retain it for your records.<br>
//       You are receiving this email because you purchased extended warranty coverage${shopUrl ? ` at ${shopUrl.replace(/^https?:\/\//, "")}` : ""}.<br><br>
